...
>
  <svg
    ...
    className="text-yellow-400 mb-6 group-hover:text-yellow-300 transition-colors"
    width="60"
    height="60"
    viewBox="0 0 24 24"
    fill="none"
  ...
  <p className="text-gray-300 text-lg leading-relaxed font-light">
    Connect with fellow coders, ask questions, share insights, and discuss solutions in real-time.
  </p>
</button>
        </div>
