...
const ProblemPage = () => {
  ...
  const [leftPanelWidth, setLeftPanelWidth] = useState(50); // Initial width as percentage
  ...
  useEffect(() => {
    const fetchProblem = async () => {
      ...
      try {
        ...
        // Initialize test case results with the visible test cases
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      // Update test case results with actual results
            ...
            <>
              ...
              {activeLeftTab === 'solutions' && (
                <div className="space-y-4">
                  ...
                  {(() => {
                    // Check if current problem is solved by user
              ...
              {/* Submission Result - Now part of left panel */}
